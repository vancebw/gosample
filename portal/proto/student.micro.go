...
type StudentService interface {
	...
	// 获取所有学生
	ListStudent(ctx context.Context, in *Request, opts ...client.CallOption) (*StudentResponse, error)
}
...
func (c *studentService) ListStudent(ctx context.Context, in *Request, opts ...client.CallOption) (*StudentResponse, error) {
...
type StudentServiceHandler interface {
	...
	// 获取所有学生
	ListStudent(context.Context, *Request, *StudentResponse) error
}
...
func RegisterStudentServiceHandler(s server.Server, hdlr StudentServiceHandler, opts ...server.HandlerOption) error {
	type studentService interface {
		...
		ListStudent(ctx context.Context, in *Request, out *StudentResponse) error
	}
	type StudentService struct {
		studentService
	}
...
func (h *studentServiceHandler) ListStudent(ctx context.Context, in *Request, out *StudentResponse) error {
